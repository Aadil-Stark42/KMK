...
class BetterVideoPlayer @JvmOverloads constructor(
    ...
    override var hideControlsDuration: Int = 3000
    ...
    override fun onFinishInflate() {
        ...
        mProgressBar.indeterminateDrawable.setColorFilter(context.resources.getColor(R.color.view_orange),android.graphics.PorterDuff.Mode.MULTIPLY)
